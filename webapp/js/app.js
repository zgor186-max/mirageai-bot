            ...
            body: JSON.stringify({
                ...
                messages: [{
                    ...
                    content: [
                        ...
                        { type: "text", text: `Ты копирайтер для маркетплейса (WB/Ozon). Товар: "${name}". Посмотри на фото и ответь ТОЛЬКО валидным JSON без markdown. ОБЯЗАТЕЛЬНО ровно 4 элемента в features — не меньше, не больше:\n{\n  "slogan": "эмоциональный слоган СТРОГО 2-3 слова ЗАГЛАВНЫМИ. НЕ название товара. Примеры: ДЛЯ УЮТНЫХ ВЕЧЕРОВ, ТВОЙ ИДЕАЛЬНЫЙ СТИЛЬ, КОМФОРТ КАЖДЫЙ ДЕНЬ",\n  "tagline": "конкретная фраза СТРОГО 3-5 слов — только суть, без воды. Примеры: мягкий хлопок для крепкого сна, стильный крой на каждый день, защита и комфорт весь день",\n  "features": [\n    {"icon": "эмодзи1", "text": "СТРОГО 1-2 слова. Конкретное свойство. Примеры: МЯГКИЙ ХЛОПОК, ДЫШАЩИЙ, СВОБОДНЫЙ КРОЙ"},\n    {"icon": "эмодзи2", "text": "СТРОГО 1-2 слова. Не повторять feat1"},\n    {"icon": "эмодзи3", "text": "СТРОГО 1-2 слова. Не повторять feat1-2"},\n    {"icon": "эмодзи4", "text": "СТРОГО 1-2 слова. Не повторять feat1-3"}\n  ]\n}\nВ features СТРОГО 4 объекта. Текст каждой фичи — максимум 2 слова. Всё на русском.` }
                    ]
                }]
            })
        });
