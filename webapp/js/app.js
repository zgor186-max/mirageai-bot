                        ...
                        { type: "text", text: `Посмотри на изображение товара. Ответь ТОЛЬКО валидным JSON без markdown и без пояснений:
{
  ...
  "subtitle": "3 конкретных свойства через буллет, строчными. Формат: свойство1 • свойство2 • свойство3. Примеры: лёгкие • дышащие • на каждый день | натуральная кожа • мягкая стелька • сезон",
  "badge": "главная характеристика товара коротко (2-4 слова, ЗАГЛАВНЫМИ, например: 100% ХЛОПОК, НАТУРАЛЬНАЯ КОЖА, 18В, WIFI 6)",
  "feat1": "КОНКРЕТНОЕ преимущество 1, максимум 2 слова. ЗАПРЕЩЕНО: стильный дизайн, высокое качество, удобный. Пиши конкретно: натуральная замша, мягкая стелька, молния сбоку, нескользящая подошва, лёгкий вес, водонепроницаем",
  "feat2": "КОНКРЕТНОЕ преимущество 2, максимум 2 слова. ЗАПРЕЩЕНО общие слова. Только конкретные свойства материала, конструкции или функции",
  "feat3": "КОНКРЕТНОЕ преимущество 3, максимум 2 слова. ЗАПРЕЩЕНО общие слова. Только конкретные свойства материала, конструкции или функции",
